...
export default function Summary() {
  const { summaryData, isLoading, isError } = useSummary();
  ...
  if (summaryData)
    return (
      <>
        <CardDataStats
          title="Tổng đơn hàng"
          total={summaryData.totalOrders.toString()}
          rate="0.43%"
          levelUp
        >
          <svg
        ...
        <CardDataStats
          ...
          total={priceRender(summaryData.totalRevenue) + "đ"}
          rate="4.35%"
          levelUp
        >
          <svg
        ...
        <CardDataStats
          ...
          total={summaryData.totalProducts.toString()}
          rate="2.59%"
          levelUp
        >
          <svg
        ...
        <CardDataStats
          ...
          total={summaryData.totalUsers.toString()}
          rate="0.95%"
          levelDown
        >
          <svg
