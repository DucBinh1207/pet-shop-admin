...
const TableTwo = () => {
  ...
  function handleCloseFoodDetail() {
    setProduct(null);
  }

  function handleCloseAddFood() {
    ...
    return (
      <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1 dark:border-strokedark dark:bg-boxdark">
          ...
          {foods.map((food, key) => (
            ...
            >
              ...
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-black dark:text-white">{food.id}</p>
              </div>
              ...
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-meta-3">{food.price}đ</p>
              </div>
        ...
        {isAddProduct && (
          <>
            <AddFood
              handleCloseAddFood={handleCloseAddFood}
              refresh={refresh}
            />
            <div
              className={cn(
